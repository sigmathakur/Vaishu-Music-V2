...
from VaishuMusic.misc import SUDOERS
from VaishuMusic.utils.database import add_sudo, remove_sudo
from VaishuMusic.utils.decorators.language import language
from VaishuMusic.utils.extraction import extract_user
from VaishuMusic.utils.inline import close_markup
...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_photo(photo="https://files.catbox.moe/3ubj8b.jpg", caption="» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.\n\n» ɴᴏᴛᴇ : ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
