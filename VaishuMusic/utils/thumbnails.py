...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("VaishuMusic/assets/font2.ttf", 30)
    font = ImageFont.truetype("VaishuMusic/assets/font.ttf", 30)
    title_font = ImageFont.truetype("VaishuMusic/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("VaishuMusic/assets/play_icons.png")
