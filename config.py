...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/sigmathakur/Vaishu-Music-V2")
...
START_IMG_URL = getenv("START_IMG_URL", "https://i.ibb.co/PGbqvySx/photo-AQADVQ9r-Gxn-Ws-VV9.jpg")
